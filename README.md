...
**주요 기능:**
- Gemini AI 기반 16페이지 스토리 + 삽화 자동 생성 (비동기 폴링 + 진행률 표시)
- 3종 책 사양 선택 (정사각형 하드커버, A4/A5 소프트커버)
- CSS 3D 페이지-플립 애니메이션 책 뷰어 (데스크탑 오픈북 / 모바일 슬라이더)
...
- 부모가 AI 생성 스토리를 직접 편집하는 co-creation 기능
- Sweetbook Webhook으로 주문 상태 실시간 추적 및 알림
